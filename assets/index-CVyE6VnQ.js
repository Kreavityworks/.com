...
`)+`
`+_);const D=U+S+h,O=U+_+p,z=kx(l,l.VERTEX_SHADER,D),F=kx(l,l.FRAGMENT_SHADER,O);l.attachShader(A,z),l.attachShader(A,F),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function I(G){if(r.debug.checkShaderErrors){const H=l.getProgramInfoLog(A)||"",Q=l.getShaderInfoLog(z)||"",de=l.getShaderInfoLog(F)||"",te=H.trim(),k=Q.trim(),B=de.trim();let J=!0,ve=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,A,z,F);else{const ge=Fx(l,z,"vertex"),L=Fx(l,F,"fragment");Ct("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
