(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&s(h)}).observe(document,{childList:!0,subtree:!0});function i(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(l){if(l.ep)return;l.ep=!0;const c=i(l);fetch(l.href,c)}})();var of={exports:{}},Oo={};var Ug;function Wb(){if(Ug)return Oo;Ug=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(s,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var p in l)p!=="key"&&(c[p]=l[p])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:h,ref:l!==void 0?l:null,props:c}}return Oo.Fragment=e,Oo.jsx=i,Oo.jsxs=i,Oo}var Lg;function qb(){return Lg||(Lg=1,of.exports=Wb()),of.exports}var d=qb(),lf={exports:{}},rt={};var Og;function Yb(){if(Og)return rt;Og=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),x=Symbol.for("react.activity"),y=Symbol.iterator;function M(U){return U===null||typeof U!="object"?null:(U=y&&U[y]||U["@@iterator"],typeof U=="function"?U:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,S={};function _(U,ne,ve){this.props=U,this.context=ne,this.refs=S,this.updater=ve||T}_.prototype.isReactComponent={},_.prototype.setState=function(U,ne){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,ne,"setState")},_.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function L(){}L.prototype=_.prototype;function D(U,ne,ve){this.props=U,this.context=ne,this.refs=S,this.updater=ve||T}var O=D.prototype=new L;O.constructor=D,A(O,_.prototype),O.isPureReactComponent=!0;var z=Array.isArray;function B(){}var I={H:null,A:null,T:null,S:null},K=Object.prototype.hasOwnProperty;function w(U,ne,ve){var Te=ve.ref;return{$$typeof:r,type:U,key:ne,ref:Te!==void 0?Te:null,props:ve}}function N(U,ne){return w(U.type,ne,U.props)}function G(U){return typeof U=="object"&&U!==null&&U.$$typeof===r}function H(U){var ne={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(ve){return ne[ve]})}var Q=/\/+/g;function de(U,ne){return typeof U=="object"&&U!==null&&U.key!=null?H(""+U.key):ne.toString(36)}function te(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(B,B):(U.status="pending",U.then(function(ne){U.status==="pending"&&(U.status="fulfilled",U.value=ne)},function(ne){U.status==="pending"&&(U.status="rejected",U.reason=ne)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function k(U,ne,ve,Te,Be){var q=typeof U;(q==="undefined"||q==="boolean")&&(U=null);var ce=!1;if(U===null)ce=!0;else switch(q){case"bigint":case"string":case"number":ce=!0;break;case"object":switch(U.$$typeof){case r:case e:ce=!0;break;case v:return ce=U._init,k(ce(U._payload),ne,ve,Te,Be)}}if(ce)return Be=Be(U),ce=Te===""?"."+de(U,0):Te,z(Be)?(ve="",ce!=null&&(ve=ce.replace(Q,"$&/")+"/"),k(Be,ne,ve,"",function(He){return He})):Be!=null&&(G(Be)&&(Be=N(Be,ve+(Be.key==null||U&&U.key===Be.key?"":(""+Be.key).replace(Q,"$&/")+"/")+ce)),ne.push(Be)),1;ce=0;var Ce=Te===""?".":Te+":";if(z(U))for(var je=0;je<U.length;je++)Te=U[je],q=Ce+de(Te,je),ce+=k(Te,ne,ve,q,Be);else if(je=M(U),typeof je=="function")for(U=je.call(U),je=0;!(Te=U.next()).done;)Te=Te.value,q=Ce+de(Te,je++),ce+=k(Te,ne,ve,q,Be);else if(q==="object"){if(typeof U.then=="function")return k(te(U),ne,ve,Te,Be);throw ne=String(U),Error("Objects are not valid as a React child (found: "+(ne==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":ne)+"). If you meant to render a collection of children, use an array instead.")}return ce}function F(U,ne,ve){if(U==null)return U;var Te=[],Be=0;return k(U,Te,"","",function(q){return ne.call(ve,q,Be++)}),Te}function $(U){if(U._status===-1){var ne=U._result;ne=ne(),ne.then(function(ve){(U._status===0||U._status===-1)&&(U._status=1,U._result=ve)},function(ve){(U._status===0||U._status===-1)&&(U._status=2,U._result=ve)}),U._status===-1&&(U._status=0,U._result=ne)}if(U._status===1)return U._result.default;throw U._result}var be=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var ne=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent(ne))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)},xe={map:F,forEach:function(U,ne,ve){F(U,function(){ne.apply(this,arguments)},ve)},count:function(U){var ne=0;return F(U,function(){ne++}),ne},toArray:function(U){return F(U,function(ne){return ne})||[]},only:function(U){if(!G(U))throw Error("React.Children.only expected to receive a single React element child.");return U}};return rt.Activity=x,rt.Children=xe,rt.Component=_,rt.Fragment=i,rt.Profiler=l,rt.PureComponent=D,rt.StrictMode=s,rt.Suspense=g,rt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=I,rt.__COMPILER_RUNTIME={__proto__:null,c:function(U){return I.H.useMemoCache(U)}},rt.cache=function(U){return function(){return U.apply(null,arguments)}},rt.cacheSignal=function(){return null},rt.cloneElement=function(U,ne,ve){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var Te=A({},U.props),Be=U.key;if(ne!=null)for(q in ne.key!==void 0&&(Be=""+ne.key),ne)!K.call(ne,q)||q==="key"||q==="__self"||q==="__source"||q==="ref"&&ne.ref===void 0||(Te[q]=ne[q]);var q=arguments.length-2;if(q===1)Te.children=ve;else if(1<q){for(var ce=Array(q),Ce=0;Ce<q;Ce++)ce[Ce]=arguments[Ce+2];Te.children=ce}return w(U.type,Be,Te)},rt.createContext=function(U){return U={$$typeof:h,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:c,_context:U},U},rt.createElement=function(U,ne,ve){var Te,Be={},q=null;if(ne!=null)for(Te in ne.key!==void 0&&(q=""+ne.key),ne)K.call(ne,Te)&&Te!=="key"&&Te!=="__self"&&Te!=="__source"&&(Be[Te]=ne[Te]);var ce=arguments.length-2;if(ce===1)Be.children=ve;else if(1<ce){for(var Ce=Array(ce),je=0;je<ce;je++)Ce[je]=arguments[je+2];Be.children=Ce}if(U&&U.defaultProps)for(Te in ce=U.defaultProps,ce)Be[Te]===void 0&&(Be[Te]=ce[Te]);return w(U,q,Be)},rt.createRef=function(){return{current:null}},rt.forwardRef=function(U){return{$$typeof:p,render:U}},rt.isValidElement=G,rt.lazy=function(U){return{$$typeof:v,_payload:{_status:-1,_result:U},_init:$}},rt.memo=function(U,ne){return{$$typeof:m,type:U,compare:ne===void 0?null:ne}},rt.startTransition=function(U){var ne=I.T,ve={};I.T=ve;try{var Te=U(),Be=I.S;Be!==null&&Be(ve,Te),typeof Te=="object"&&Te!==null&&typeof Te.then=="function"&&Te.then(B,be)}catch(q){be(q)}finally{ne!==null&&ve.types!==null&&(ne.types=ve.types),I.T=ne}},rt.unstable_useCacheRefresh=function(){return I.H.useCacheRefresh()},rt.use=function(U){return I.H.use(U)},rt.useActionState=function(U,ne,ve){return I.H.useActionState(U,ne,ve)},rt.useCallback=function(U,ne){return I.H.useCallback(U,ne)},rt.useContext=function(U){return I.H.useContext(U)},rt.useDebugValue=function(){},rt.useDeferredValue=function(U,ne){return I.H.useDeferredValue(U,ne)},rt.useEffect=function(U,ne){return I.H.useEffect(U,ne)},rt.useEffectEvent=function(U){return I.H.useEffectEvent(U)},rt.useId=function(){return I.H.useId()},rt.useImperativeHandle=function(U,ne,ve){return I.H.useImperativeHandle(U,ne,ve)},rt.useInsertionEffect=function(U,ne){return I.H.useInsertionEffect(U,ne)},rt.useLayoutEffect=function(U,ne){return I.H.useLayoutEffect(U,ne)},rt.useMemo=function(U,ne){return I.H.useMemo(U,ne)},rt.useOptimistic=function(U,ne){return I.H.useOptimistic(U,ne)},rt.useReducer=function(U,ne,ve){return I.H.useReducer(U,ne,ve)},rt.useRef=function(U){return I.H.useRef(U)},rt.useState=function(U){return I.H.useState(U)},rt.useSyncExternalStore=function(U,ne,ve){return I.H.useSyncExternalStore(U,ne,ve)},rt.useTransition=function(){return I.H.useTransition()},rt.version="19.2.3",rt}var Pg;function Fh(){return Pg||(Pg=1,lf.exports=Yb()),lf.exports}var me=Fh(),cf={exports:{}},Po={},uf={exports:{}},df={};var Ig;function Kb(){return Ig||(Ig=1,(function(r){function e(k,F){var $=k.length;k.push(F);e:for(;0<$;){var be=$-1>>>1,xe=k[be];if(0<l(xe,F))k[be]=F,k[$]=xe,$=be;else break e}}function i(k){return k.length===0?null:k[0]}function s(k){if(k.length===0)return null;var F=k[0],$=k.pop();if($!==F){k[0]=$;e:for(var be=0,xe=k.length,U=xe>>>1;be<U;){var ne=2*(be+1)-1,ve=k[ne],Te=ne+1,Be=k[Te];if(0>l(ve,$))Te<xe&&0>l(Be,ve)?(k[be]=Be,k[Te]=$,be=Te):(k[be]=ve,k[ne]=$,be=ne);else if(Te<xe&&0>l(Be,$))k[be]=Be,k[Te]=$,be=Te;else break e}}return F}function l(k,F){var $=k.sortIndex-F.sortIndex;return $!==0?$:k.id-F.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var h=Date,p=h.now();r.unstable_now=function(){return h.now()-p}}var g=[],m=[],v=1,x=null,y=3,M=!1,T=!1,A=!1,S=!1,_=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function O(k){for(var F=i(m);F!==null;){if(F.callback===null)s(m);else if(F.startTime<=k)s(m),F.sortIndex=F.expirationTime,e(g,F);else break;F=i(m)}}function z(k){if(A=!1,O(k),!T)if(i(g)!==null)T=!0,B||(B=!0,H());else{var F=i(m);F!==null&&te(z,F.startTime-k)}}var B=!1,I=-1,K=5,w=-1;function N(){return S?!0:!(r.unstable_now()-w<K)}function G(){if(S=!1,B){var k=r.unstable_now();w=k;var F=!0;try{e:{T=!1,A&&(A=!1,L(I),I=-1),M=!0;var $=y;try{t:{for(O(k),x=i(g);x!==null&&!(x.expirationTime>k&&N());){var be=x.callback;if(typeof be=="function"){x.callback=null,y=x.priorityLevel;var xe=be(x.expirationTime<=k);if(k=r.unstable_now(),typeof xe=="function"){x.callback=xe,O(k),F=!0;break t}x===i(g)&&s(g),O(k)}else s(g);x=i(g)}if(x!==null)F=!0;else{var U=i(m);U!==null&&te(z,U.startTime-k),F=!1}}break e}finally{x=null,y=$,M=!1}F=void 0}}finally{F?H():B=!1}}}var H;if(typeof D=="function")H=function(){D(G)};else if(typeof MessageChannel<"u"){var Q=new MessageChannel,de=Q.port2;Q.port1.onmessage=G,H=function(){de.postMessage(null)}}else H=function(){_(G,0)};function te(k,F){I=_(function(){k(r.unstable_now())},F)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(k){k.callback=null},r.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<k?Math.floor(1e3/k):5},r.unstable_getCurrentPriorityLevel=function(){return y},r.unstable_next=function(k){switch(y){case 1:case 2:case 3:var F=3;break;default:F=y}var $=y;y=F;try{return k()}finally{y=$}},r.unstable_requestPaint=function(){S=!0},r.unstable_runWithPriority=function(k,F){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var $=y;y=k;try{return F()}finally{y=$}},r.unstable_scheduleCallback=function(k,F,$){var be=r.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?be+$:be):$=be,k){case 1:var xe=-1;break;case 2:xe=250;break;case 5:xe=1073741823;break;case 4:xe=1e4;break;default:xe=5e3}return xe=$+xe,k={id:v++,callback:F,priorityLevel:k,startTime:$,expirationTime:xe,sortIndex:-1},$>be?(k.sortIndex=$,e(m,k),i(g)===null&&k===i(m)&&(A?(L(I),I=-1):A=!0,te(z,$-be))):(k.sortIndex=xe,e(g,k),T||M||(T=!0,B||(B=!0,H()))),k},r.unstable_shouldYield=N,r.unstable_wrapCallback=function(k){var F=y;return function(){var $=y;y=F;try{return k.apply(this,arguments)}finally{y=$}}}})(df)),df}var zg;function Zb(){return zg||(zg=1,uf.exports=Kb()),uf.exports}var ff={exports:{}},Dn={};var kg;function Qb(){if(kg)return Dn;kg=1;var r=Fh();function e(g){var m="https://react.dev/errors/"+g;if(1<arguments.length){m+="?args[]="+encodeURIComponent(arguments[1]);for(var v=2;v<arguments.length;v++)m+="&args[]="+encodeURIComponent(arguments[v])}return"Minified React error #"+g+"; visit "+m+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var s={d:{f:i,r:function(){throw Error(e(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function c(g,m,v){var x=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:x==null?null:""+x,children:g,containerInfo:m,implementation:v}}var h=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function p(g,m){if(g==="font")return"";if(typeof m=="string")return m==="use-credentials"?m:""}return Dn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Dn.createPortal=function(g,m){var v=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!m||m.nodeType!==1&&m.nodeType!==9&&m.nodeType!==11)throw Error(e(299));return c(g,m,null,v)},Dn.flushSync=function(g){var m=h.T,v=s.p;try{if(h.T=null,s.p=2,g)return g()}finally{h.T=m,s.p=v,s.d.f()}},Dn.preconnect=function(g,m){typeof g=="string"&&(m?(m=m.crossOrigin,m=typeof m=="string"?m==="use-credentials"?m:"":void 0):m=null,s.d.C(g,m))},Dn.prefetchDNS=function(g){typeof g=="string"&&s.d.D(g)},Dn.preinit=function(g,m){if(typeof g=="string"&&m&&typeof m.as=="string"){var v=m.as,x=p(v,m.crossOrigin),y=typeof m.integrity=="string"?m.integrity:void 0,M=typeof m.fetchPriority=="string"?m.fetchPriority:void 0;v==="style"?s.d.S(g,typeof m.precedence=="string"?m.precedence:void 0,{crossOrigin:x,integrity:y,fetchPriority:M}):v==="script"&&s.d.X(g,{crossOrigin:x,integrity:y,fetchPriority:M,nonce:typeof m.nonce=="string"?m.nonce:void 0})}},Dn.preinitModule=function(g,m){if(typeof g=="string")if(typeof m=="object"&&m!==null){if(m.as==null||m.as==="script"){var v=p(m.as,m.crossOrigin);s.d.M(g,{crossOrigin:v,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0})}}else m==null&&s.d.M(g)},Dn.preload=function(g,m){if(typeof g=="string"&&typeof m=="object"&&m!==null&&typeof m.as=="string"){var v=m.as,x=p(v,m.crossOrigin);s.d.L(g,v,{crossOrigin:x,integrity:typeof m.integrity=="string"?m.integrity:void 0,nonce:typeof m.nonce=="string"?m.nonce:void 0,type:typeof m.type=="string"?m.type:void 0,fetchPriority:typeof m.fetchPriority=="string"?m.fetchPriority:void 0,referrerPolicy:typeof m.referrerPolicy=="string"?m.referrerPolicy:void 0,imageSrcSet:typeof m.imageSrcSet=="string"?m.imageSrcSet:void 0,imageSizes:typeof m.imageSizes=="string"?m.imageSizes:void 0,media:typeof m.media=="string"?m.media:void 0})}},Dn.preloadModule=function(g,m){if(typeof g=="string")if(m){var v=p(m.as,m.crossOrigin);s.d.m(g,{as:typeof m.as=="string"&&m.as!=="script"?m.as:void 0,crossOrigin:v,integrity:typeof m.integrity=="string"?m.integrity:void 0})}else s.d.m(g)},Dn.requestFormReset=function(g){s.d.r(g)},Dn.unstable_batchedUpdates=function(g,m){return g(m)},Dn.useFormState=function(g,m,v){return h.H.useFormState(g,m,v)},Dn.useFormStatus=function(){return h.H.useHostTransitionStatus()},Dn.version="19.2.3",Dn}var Bg;function $b(){if(Bg)return ff.exports;Bg=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(e){console.error(e)}}return r(),ff.exports=Qb(),ff.exports}var Fg;function Jb(){if(Fg)return Po;Fg=1;var r=Zb(),e=Fh(),i=$b();function s(t){var n="https://react.dev/errors/"+t;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+t+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function c(t){var n=t,a=t;if(t.alternate)for(;n.return;)n=n.return;else{t=n;do n=t,(n.flags&4098)!==0&&(a=n.return),t=n.return;while(t)}return n.tag===3?a:null}function h(t){if(t.tag===13){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function p(t){if(t.tag===31){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function g(t){if(c(t)!==t)throw Error(s(188))}function m(t){var n=t.alternate;if(!n){if(n=c(t),n===null)throw Error(s(188));return n!==t?null:t}for(var a=t,o=n;;){var u=a.return;if(u===null)break;var f=u.alternate;if(f===null){if(o=u.return,o!==null){a=o;continue}break}if(u.child===f.child){for(f=u.child;f;){if(f===a)return g(u),t;if(f===o)return g(u),n;f=f.sibling}throw Error(s(188))}if(a.return!==o.return)a=u,o=f;else{for(var b=!1,R=u.child;R;){if(R===a){b=!0,a=u,o=f;break}if(R===o){b=!0,o=u,a=f;break}R=R.sibling}if(!b){for(R=f.child;R;){if(R===a){b=!0,a=f,o=u;break}if(R===o){b=!0,o=f,a=u;break}R=R.sibling}if(!b)throw Error(s(189))}}if(a.alternate!==o)throw Error(s(190))}if(a.tag!==3)throw Error(s(188));return a.stateNode.current===a?t:n}function v(t){var n=t.tag;if(n===5||n===26||n===27||n===6)return t;for(t=t.child;t!==null;){if(n=v(t),n!==null)return n;t=t.sibling}return null}var x=Object.assign,y=Symbol.for("react.element"),M=Symbol.for("react.transitional.element"),T=Symbol.for("react.portal"),A=Symbol.for("react.fragment"),S=Symbol.for("react.strict_mode"),_=Symbol.for("react.profiler"),L=Symbol.for("react.consumer"),D=Symbol.for("react.context"),O=Symbol.for("react.forward_ref"),z=Symbol.for("react.suspense"),B=Symbol.for("react.suspense_list"),I=Symbol.for("react.memo"),K=Symbol.for("react.lazy"),w=Symbol.for("react.activity"),N=Symbol.for("react.memo_cache_sentinel"),G=Symbol.iterator;function H(t){return t===null||typeof t!="object"?null:(t=G&&t[G]||t["@@iterator"],typeof t=="function"?t:null)}var Q=Symbol.for("react.client.reference");function de(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===Q?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case A:return"Fragment";case _:return"Profiler";case S:return"StrictMode";case z:return"Suspense";case B:return"SuspenseList";case w:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case T:return"Portal";case D:return t.displayName||"Context";case L:return(t._context.displayName||"Context")+".Consumer";case O:var n=t.render;return t=t.displayName,t||(t=n.displayName||n.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case I:return n=t.displayName||null,n!==null?n:de(t.type)||"Memo";case K:n=t._payload,t=t._init;try{return de(t(n))}catch{}}return null}var te=Array.isArray,k=e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,F=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,$={pending:!1,data:null,method:null,action:null},be=[],xe=-1;function U(t){return{current:t}}function ne(t){0>xe||(t.current=be[xe],be[xe]=null,xe--)}function ve(t,n){xe++,be[xe]=t.current,t.current=n}var Te=U(null),Be=U(null),q=U(null),ce=U(null);function Ce(t,n){switch(ve(q,n),ve(Be,t),ve(Te,null),n.nodeType){case 9:case 11:t=(t=n.documentElement)&&(t=t.namespaceURI)?tg(t):0;break;default:if(t=n.tagName,n=n.namespaceURI)n=tg(n),t=ng(n,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}ne(Te),ve(Te,t)}function je(){ne(Te),ne(Be),ne(q)}function He(t){t.memoizedState!==null&&ve(ce,t);var n=Te.current,a=ng(n,t.type);n!==a&&(ve(Be,t),ve(Te,a))}function ht(t){Be.current===t&&(ne(Te),ne(Be)),ce.current===t&&(ne(ce),No._currentValue=$)}var Jt,xt;function pt(t){if(Jt===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Jt=n&&n[1]||"",xt=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Jt+t+xt}var Dt=!1;function ot(t,n){if(!t||Dt)return"";Dt=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var o={DetermineComponentFrameRoot:function(){try{if(n){var _e=function(){throw Error()};if(Object.defineProperty(_e.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(_e,[])}catch(ue){var oe=ue}Reflect.construct(t,[],_e)}else{try{_e.call()}catch(ue){oe=ue}t.call(_e.prototype)}}else{try{throw Error()}catch(ue){oe=ue}(_e=t())&&typeof _e.catch=="function"&&_e.catch(function(){})}}catch(ue){if(ue&&oe&&typeof ue.stack=="string")return[ue.stack,oe.stack]}return[null,null]}};o.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(o.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(o.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=o.DetermineComponentFrameRoot(),b=f[0],R=f[1];if(b&&R){var j=b.split(`
`),se=R.split(`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xa,depthTest:!1,depthWrite:!1})}function S2(r,e,i){const s=new Float32Array(Cs),l=new ie(0,1,0);return new Xi({name:"SphericalGaussianBlur",defines:{n:Cs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:tu(),fragmentShader:`
...
`)}const wT={[av]:"Linear",[sv]:"Reinhard",[rv]:"Cineon",[ov]:"ACESFilmic",[cv]:"AgX",[uv]:"Neutral",[lv]:"Custom"};function RT(r,e){const i=wT[e];return i===void 0?(at("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Pc=new ie;function CT(){At.getLuminanceCoefficients(Pc);const r=Pc.x.toFixed(4),e=Pc.y.toFixed(4),i=Pc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Xo).join(`
`)),h=Bh(h),h=jx(h,i),h=Hx(h,i),p=Bh(p),p=jx(p,i),p=Hx(p,i),h=Gx(h),p=Gx(p),i.isRawShaderMaterial!==!0&&(L=`#version 300 es
...
`)+`
`+_);const D=L+S+h,O=L+_+p,z=kx(l,l.VERTEX_SHADER,D),B=kx(l,l.FRAGMENT_SHADER,O);l.attachShader(A,z),l.attachShader(A,B),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function I(G){if(r.debug.checkShaderErrors){const H=l.getProgramInfoLog(A)||"",Q=l.getShaderInfoLog(z)||"",de=l.getShaderInfoLog(B)||"",te=H.trim(),k=Q.trim(),F=de.trim();let $=!0,be=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,A,z,B);else{const xe=Fx(l,z,"vertex"),U=Fx(l,B,"fragment");Ct("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
